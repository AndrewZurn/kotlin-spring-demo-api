...
class ProductsService {
  ...
  private val products: MutableList<Product> = mutableListOf<Product>(
      Product(UUID.fromString("00ae9676-2a48-4703-bc9d-0fed1d0537eb"), "pizza", "some sausage and pepperoni"),
      Product(UUID.fromString("f783c79b-054b-4744-b50b-581b8f90db10"), "beer", "some delicious IPA")
  )
